...
- Canonical Pi branch observations and relevant tool evidence coalesce bounded analysis work. Idle redraws, clocks, unchanged snapshots, and monitoring entries never dispatch inference; finite valid work drains with one Jev request in flight and a yielded local turn between dispatches.
